...
def test_booleans():
    ...
    Boolean represent the truth value False and True. The two objects representing the values
...
def test_float_numbers():
    ...
    Float, or " floating point number" is a number, positve or negative,
...
def test_number_operators():
    ...
    # mixed type operands covert the interger operand to floating point.
